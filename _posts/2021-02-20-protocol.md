...
| Enzymatics RNase Inhibitor | | PBSI和Lysis Buffer和NIB用，待确定 |
| BSA | | PBSI用，已有 |
| FA | | 母液浓度37%，已有 |
| Glycine | | 已有 |
| RNase-free water | | 已有 |
...
| Triton X-100 | | 已有 |
| SDS | | 待确定 |
| 10X NEBuffer 3.1 | | 待确定 |
| T4 DNA Ligase Buffer | NEB | 终浓度1X,2X，母液应该10X,溶解blocking strand etc.用，待确定 |
| T4 DNA Ligase | | 待确定 | 
| dA reaction buffer | | NEBNext dA-Tailing Module，见溶液配制，待确定 |
| formaldehyde (FA) | 28906, ThermoFisher | final concentration of 0.1% for cell lines or 0.2% for primary tissues in share-seq，已有 |
| HpyCH4V | NEB, #R0620L, Ispwich, MA | 师兄已经订货 |
| dA-tail reaction buffer | NEBNext dA-Tailing Module (NEB, #E6053L, Ispwich, MA)，待确定 |
| Klenow Fragment | NEBNext dA-Tailing Module (NEB, #E6053L, Ispwich, MA)，待确定 |
| dNTP | | RT用，待确定 |
